...
namespace HotTipster
{
    public static class ImportDefaultData
    {
        public static List<HorseBet> ImportData()
        {
            ...
            //originalTextData = originalTextData.Remove('(');
            //originalTextData = originalTextData.Remove(')');
            ...
            while (regExMatch.Success)
            {
                ...
                //Console.WriteLine("Course:-{0}-", tempRaceCourse);
                ...
                //Console.WriteLine("Date:-{0}-", tempRaceDate.ToShortDateString());
                ...
                //Console.WriteLine("Money:-{0}-", tempBalanceChange);


                // Get Won / Lost Bool                
                regExMatch = regExMatch.NextMatch();                
                bool.TryParse(regExMatch.ToString(), out bool tempRaceWasWon);
                //Console.WriteLine("Bool: {0}", tempRaceWasWon);
